...
function RiderLoginForm() {
  ...
  return (
    <div className="w-full max-w-sm px-4">
      ...
      <Link
        href="/login"
        className="inline-flex items-center gap-1.5 text-sm text-green-200 hover:text-white transition-colors mb-8"
      >
      ...
      <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 shadow-2xl">
        ...
        {/* Info banner */}
        <div className="bg-white/10 border border-white/20 rounded-2xl px-4 py-3 mb-6 text-sm text-green-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-semibold text-green-100 mb-1.5">Email address</label>
            <div className="relative">
              <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-green-300" />
              <input
                type="email"
                required
                autoComplete="email"
                ...
                className="w-full bg-white/10 border border-white/20 text-white placeholder-green-300/60
          ...
          <div>
            <label className="block text-sm font-semibold text-green-100 mb-1.5">Password</label>
            <div className="relative">
              <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-green-300" />
              <input
              ...
              <button
                ...
                tabIndex={-1}
                className="absolute right-3.5 top-1/2 -translate-y-1/2 text-green-300 hover:text-white transition-colors"
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 mt-2 py-3.5 rounded-2xl font-bold
                       text-primary bg-white hover:bg-green-50 transition-colors disabled:opacity-60 shadow-lg"
          >
            {loading ? (
              <span className="w-5 h-5 border-2 border-green-300 border-t-primary rounded-full animate-spin" />
            ) : (
...
export default function RiderLoginPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary via-green-600 to-green-700
