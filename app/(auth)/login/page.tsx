    ...
    <div className="w-full max-w-md">
      <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 shadow-modal border border-border">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2.5 bg-gray-950 hover:bg-gray-800
                     text-white rounded-xl py-2 px-4 text-xs font-semibold transition-colors
                     disabled:opacity-50 disabled:cursor-not-allowed mb-4 border border-gray-800"
        >
          {googleLoading ? (
